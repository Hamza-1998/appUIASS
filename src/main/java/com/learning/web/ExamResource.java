...
public class ExamResource {
	...
	public ResponseEntity<?> findByCriteres(@RequestBody Demande<ExamDTO> demande) {
		try {
			...
			LOGGER.error("Problem occored in api/exam" + ConstantBase.CRUD_REST_FIND_BY_CRITERE + " : {} ", e);
	...
	public ResponseEntity<?> findById(@PathVariable Long id) {
		try {
			...
			LOGGER.error("Problem occored in api/exam" + ConstantBase.CRUD_REST_FIND_BY_ID + " : {} ", e);
			return new ResponseEntity<>(ConstantBase.SERVER_ERROR, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<?> deleteById(@PathVariable Long id) {
		try {
			...
			LOGGER.error("Problem occored in api/exam" + ConstantBase.CRUD_REST_DELETE + " : {} ", e);
			return new ResponseEntity<>(ConstantBase.SERVER_ERROR, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
